...
*/	public static final String BS_USERNAME = "itqatestteamluto1";
	...
	public static final String ServiceUser = "?username=ashish.setia&api-key={415D8E5E-31A4-44E5-B8CB-AE730A039C96}";
	public static final String ProjectDetail = "https://impellam.spiraservice.net/Services/v5_0/RestService.svc/projects/{project_id}";
	public static final String ReleaseDetail = "https://impellam.spiraservice.net/Services/v5_0/RestService.svc/projects/{project_id}/releases/{release_id}";
	public static final String TestCasesInSet = "https://impellam.spiraservice.net/Services/v5_0/RestService.svc/projects/{project_id}/test-sets/{test_set_id}/test-cases";
	public static final String TestSteps = 	"https://impellam.spiraservice.net/Services/v5_0/RestService.svc/projects/{project_id}/test-cases/{test_case_id}";
	public static final String TestSet = "https://impellam.spiraservice.net/Services/v5_0/RestService.svc/projects/{project_id}/test-sets/{test_set_id}";
	...
	public static final String RunfromHost = "https://impellam.spiraservice.net/Services/v5_0/RestService.svc/projects/{project_id}/test-runs/create/automation_host/{automation_host_token}";
	...
	//public static final String espireLogo = "image/logo.png";
	public static final String espireLogo = "http://www.impellam.com/style%20library/assets/images/logo.gif";
	public static final String stop = "image/stop.jpg";
	public static final String pause = "image/pause.jpg";
	public static final String play = "image/play.jpg";
	...
	public static String Path_IgniteTestCaseRun = "IgniteTestCaseRun.xlsx";
	public static final String FileUpload="ObjectRepository/FileUpload.exe";
	...
	public static  String File_DownloadPath = "C://temp";
	...
	public static final String CheckTextNotDisplayed = "check text not displayed";
	...
	public static final String FetchFromDb = "fetch from database";
	...
	public static final String StoreURL = "store url";
	public static final String CloseApplication = "close application";
	public static final String CloseBrowser = "close browser";
	public static final String DeleteCookie = "delete cookie";
	public static final String CheckAutosuggest = "check autosuggest";
	public static final String Autosuggest = "autosuggest";
	public static final String Innerloop = "innerloop";
	public static final String Endinnerloop = "endinnerloop";
